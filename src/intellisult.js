function intellisult(name) {
    var config = intellisult.config;
    var A = config.A,
        B = config.B,
        C = config.C,
        D = config.D,
